...
export const SERVICES: ServiceArea[] = [
  {
    ...
    descripcionCorta: "Asesoría integral y litigio en relaciones laborales individuales, contratos de trabajo, despidos, fueros de estabilidad y negociaciones colectivas.",
    icono: "Users",
  ...
  },
  {
    ...
    descripcionCorta: "Gestión, estructuración y radicación estratégica de visas colombianas de visitante (V), migrante (M) y residente (R) ante la Cancillería.",
    icono: "Globe",
  ...
  },
  {
    ...
    descripcionCorta: "Defensa jurídica para el reconocimiento efectivo de pensiones de vejez, invalidez, sobrevivientes, reliquidaciones y traslados de régimen.",
    icono: "Landmark",
  ...
  },
  {
    ...
    descripcionCorta: "Reclamación judicial de indemnización plena y ordinaria de perjuicios por accidentes de trabajo y enfermedades laborales (Art. 216 CST).",
    icono: "ShieldAlert",
  ...
  },
  {
    ...
    descripcionCorta: "Esquema integral de asesoramiento corporativo continuo bajo tarifa mensual: consultoría preventiva, contratos, compliance y mitigación de riesgos.",
  ...
  },
  {
    ...
    descripcionCorta: "Soluciones jurídicas estratégicas y humanas en divorcios, cesación de efectos civiles, liquidación conyugal, alimentos, custodias y sucesiones.",
    icono: "Heart",
  ...
  },
  {
    ...
    descripcionCorta: "Trámites de adquisición de nacionalidad colombiana por adopción o nacimiento, recuperación de nacionalidad y corrección de registros civiles.",
    icono: "FileText",
  ...
  },
  {
    ...
    descripcionCorta: "Representación judicial técnica y rigurosa en procesos declarativos, ordinarios, ejecutivos y de responsabilidad civil ante jueces y tribunales.",
    icono: "Scale",
  ...
  },
  {
    ...
    descripcionCorta: "Asesoría jurídica societaria y mercantil: constitución de empresas, contratos comerciales, títulos valores, competencia leal e insolvencia.",
    icono: "Building2",
  ...
  },
  {
    ...
    descripcionCorta: "Protección judicial expedita de derechos fundamentales: salud, debido proceso, mínimo vital, estabilidad laboral reforzada y desacatos.",
    icono: "Shield",
  ...
  },
  {
    ...
    descripcionCorta: "Defensa jurídica frente a objeciones injustificadas de siniestros, seguros de vida, incapacidad total, cumplimiento, autos y responsabilidad civil.",
    icono: "ShieldCheck",
